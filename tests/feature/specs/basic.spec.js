import VueDraggableResizable from '@/components/vdrr'
...
describe('Basic', function () {
  ...
  it('should render the component with 9 handles by default', function () {
    wrapper = mount(VueDraggableResizable)
    expect(wrapper.findAll('div.handle').length).to.equal(9)
  })

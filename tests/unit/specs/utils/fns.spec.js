...
import { isFunction, snapToGrid, restrictToBounds, rotatedPoint } from '@/components/vdrr/utils/fns'
...
describe('fns', function () {
  ...
  describe('rotatedPoint', function () {
    it('rotatedPoint，计算精度保持在千分之一之内', function () {
      ...
      // 0 1 顺时针旋转45
      expect(rotatedPoint(0, 0, 0, 1, -45).x).to.be.within(0.7070, 0.7072)
      expect(rotatedPoint(0, 0, 0, 1, -45).y).to.be.within(0.7070, 0.7072)
      // 0 1 顺时针旋转90
